...
public class DateChooseCustomModule {
    ...
    public static void handlingChooseCustom(Context context, Runnable runnable, boolean isCondition) {
        ...
        eventChooseTime(buttonChooseTime, editTextDateStart, editTextDateEnd, context, runnable);
    }

    private static void eventChooseTime(final Button buttonChooseTime, final EditText editTextDateStart,
                                        final EditText editTextDateEnd, final Context context, final Runnable runnable) {
